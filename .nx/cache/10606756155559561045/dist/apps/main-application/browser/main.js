...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-GJD46CNA.js").then((m) => m);
...
var appRoutes = [
  ...
  {
    path: "demo",
    loadComponent: () => import("./chunk-PNZNKEBL.js").then((m) => m.RealtimeDemoComponent)
  }
];
